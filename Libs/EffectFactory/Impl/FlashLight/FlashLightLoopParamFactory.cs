...
namespace MMGame.EffectFactory.FlashLight
{
    ...
    /// </summary>
    [System.Serializable]
    public class FlashLightLoopParamFactory : PlayLoopParamFactory
    {
        ...
        {
            Transform objPrefab = Prefab.Load("FlashLightLoopParamObject");
            Transform xform = PoolManager.Spawn(objPrefab.name, objPrefab);
            FlashLightLoopParamObject obj = xform.GetComponent<FlashLightLoopParamObject>();
