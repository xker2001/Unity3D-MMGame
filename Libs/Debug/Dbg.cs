...
public class Dbg: MonoBehaviour
{
    ...
    [SerializeField] private GameObject buttonSwitchLog;
    [SerializeField] private GameObject buttonClearLog;
    ...
    private void HandleLog (string logString, string stackTrace, LogType type)
    {
        ...
        {
            Dbg.Log (logString, Color.red);
            Dbg.Log ("<i>" + stackTrace + "</i>");
        }
        else if (type == LogType.Log)
        {
            Dbg.Log (logString, Color.white);
        }
        else if (type == LogType.Assert)
        {
            Dbg.Log (logString, Color.yellow);
        }
    }
