...
namespace MMGame.UI
{
    ...
    /// - 所有 item 大小相同。
    /// </summary>
    public class UIHorizontalPoolablePageLayout : AUILayout,
                                                  IUIPoolableItemLayout, IUISizeFitableLayout, IUIScrolltoableLayout
    {
        /// <summary>
        /// PageRect 物体。
        /// </summary>
        ...
        private readonly List<UIPoolablePage> pages = new List<UIPoolablePage>();
        ...
        {
            foreach (UIPoolablePage page in pages)
            {
                page.Reset();
            }
        ...
        public void Refresh()
        {
            ...
            {
                var page = new UIPoolablePage
                {
                    PageLayout = rectTransform,
                    PageSize = pageSize,
        ...
        {
            Size = new Vector2(pageSize.x * itemDatas.Count + pageSpace * (itemDatas.Count - 1),
